...
from send_data import send_telegram_message

params = {}

# settings related to dataset
params['data_name'] = 'Hopf'
params['len_time'] = 51
n = 2  # dimension of system (and input layer)
num_initial_conditions = 1000  # per training file
params['delta_t'] = 0.01

# settings related to saving results
params['folder_name'] = 'res/Hopf'
...
for count in tqdm(range(50)):  # loop to do random experiments
    ...
    send_telegram_message(f'Training {count+1}th - completed!')

send_telegram_message(f'Execution of the Kutz - Brunton NN of Hopf model completed')